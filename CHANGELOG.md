...
- Уведомление о новой версии приложения в боковом меню.
...
- Возможность отключить отслеживание "Лучшего хода" в настройках.

### Удалено

- Возможность убрать фол, убить или воскресить игрока вручную. Эта возможность всё ещё доступна,
  если приложение собрано в режиме отладки.
...
[unreleased]: https://github.com/evgfilim1/mafia-companion/compare/v0.2.0-rc.1...HEAD
