...
- Информация о приложении и ссылка на исходный код в меню "О приложении".
- Настройка правил:
  - проводить ли голосование, даже если результат уже понятен.

### Изменено

- "Голосование за подъём стола" переименовано в "Голосование за подъём всех игроков".
...
[unreleased]: https://github.com/evgfilim1/mafia-companion/compare/v0.3.0-rc.2...HEAD
[v0.3.0-rc.2]: https://github.com/evgfilim1/mafia-companion/releases/tag/v0.3.0-rc.2
